      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 mb-8">
        <div>
          ...
          {isEditing ? (
            <input
              ...
              className="w-full h-11 rounded-xl border border-[#2E7D1E]/30 bg-white px-4 text-sm text-gray-700 outline-none transition focus:border-[#2E7D1E] focus:ring-1 focus:ring-[#2E7D1E]"
            />
          ) : (
            <div className="flex h-11 w-full items-center rounded-xl bg-gray-55 px-4 text-sm font-semibold text-gray-800 border border-gray-100">
        ...
        <div>
          ...
          {isEditing ? (
            ...
            <div className="flex h-11 w-full items-center rounded-xl bg-gray-55 px-4 text-sm text-gray-800 border border-gray-100">
